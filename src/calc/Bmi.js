      ...
      <div className="moon">
        ...
        <div className="App-header">
          ...
          <form onSubmit={this.submitMe}>
           ...
           <br></br>
            <input type="text" name="name" value={this.state.name} onBlur={this.blur} onChange={this.change}/><br></br>
             <label>
             Enter your height in cm: 
            </label>       <br></br>
            <input type="text" name="height" value={this.state.height} onBlur={this.blur} onChange={this.heightchange}/><br></br>
             <label>
             Enter your weight in kg : 
            </label>       <br></br>
            <input type="text" name="weight" value={this.state.weight} onChange={this.weightchange} /><br></br>
